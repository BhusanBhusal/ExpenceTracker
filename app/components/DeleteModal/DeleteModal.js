...
export default function DeleteConfirmation({ openDelete, deleteIncome, setOpenDelete, deleteId }) {
                    ...
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        ...
                        >
                            ...
                            <div className=" px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                ...
                                <button
                                    type="button"
                                    className="mt-3 inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1  sm:mt-0 sm:w-auto"
